...
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			easeTime: 1500, //time of scroll
			asTimer: 8000, //delay time
			thumbs: 5,
			thumbsPercentReduction: 12,
			thumbsVis: true, //visible thums
	...
	return this.each(function(){
		...
		var pictWidth1 = container.find("img").attr("width");
		//var pictHeight = container.find("img").attr("height");
		
		
	
		/*======================================================================================================*/
		var redW = screen.width / 10;
		var redH = screen.height / 10;
		//alert(redH);
		
		//var pictWidth = screen.width - 65;
		//var pictHeight = screen.height - 250;
		
		//var redW = window.innerWidth / 20;
		//var redH = window.innerHeight / 8;
		
		
		var pictWidth = window.innerWidth * 0.998;
		var pictHeight = window.innerHeight * 0.9;
		$("#home_slider").find("img").each(function(){
			$(this).attr("width",pictWidth);
			$(this).attr("height",pictHeight);	
		});
    ...
    .wrap(jQuery("<div style='width:"+ pictWidth +"px; overflow: hidden; position: relative; top: 0; left: 0'>"));
		...
		container.each(function(i) {
			...
			jQuery(this).find("li").each(function(n) {
						jQuery("div#thumbSlider" + j + " ul").append("<li><a id='" + jQuery(this).find("img").attr("id") + "' title='" + jQuery(this).find("img").attr("alt") + "' href='#'><img width='"+ thumbsWidth +"' height='"+ thumbsHeight +"' src='" + jQuery(this).find("img").attr("src") + "' /><p class='tmbrdr'>&nbsp;<\/p><\/a><\/li>");
			});
			var i = 1;
			jQuery("div#thumbSlider" + j + " a").each(function(z) {
				jQuery(this).bind("click", function(){
					...
					//todo: when slide is scrolling

					//alert(i);
					//document.write(i);
					//window.location.href = "index.php?city=" + i;
					/*document.getElementById("test1").src = "images/i" + i +".jpg";
					document.getElementById("test2").src = "images/a" + i +".jpg";
					document.getElementById("test3").src = "images/i" + (i+1) +".jpg";
					*/

					var city_id = $(this).parent().find("a").attr("id");
					$.get(
					"php_ajax/run_top.php?city="+ city_id,
						function(data){
							$("#top_three").html(data);
						}
					);
					...
					switch (i)
					{
						case 1:	document.getElementById("test").src = "images/i1.jpg";
						case 2:	document.getElementById("test").src = "images/i2.jpg";
						case 3:	document.getElementById("test").src = "images/i3.jpg";
						case 4:	document.getElementById("test").src = "images/i4.jpg";
					}
					*/
