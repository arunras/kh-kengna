...
if(isset($_GET['city']))
{
 ...
 /*===City===================================================================================================================================*/
	...
	{
		$where = $_GET['where'];
		$request_hotels = $hotel_info." FROM tbl_hotels AS Ho WHERE Ho.hotel_city=".$city. $hotel_enabled;
	}
 /*===end City===================================================================================================================================*/
 /*===Khan===================================================================================================================================*/
	...
	{
		$khan = $_GET['khan'];
		$request_hotels = $hotel_info." FROM tbl_hotels AS Ho WHERE Ho.hotel_city=".$city." AND hotel_khan=".$khan. $hotel_enabled. " ORDER BY RAND()";
	}
 /*===end Khan===================================================================================================================================*/
 /*===Pop===================================================================================================================================*/
 	if(isset($_GET['pop']))
	{
		...
		$q_pop = ", Co.count_value
					...
					WHERE Ho.hotel_city=".$city. $hotel_enabled . "
					GROUP BY hotel_id
		...
		$q_pop = ", Ra.hotel_rate_value
					FROM tbl_hotels AS Ho
					INNER JOIN tbl_write_review AS Ra ON Ho.hotel_id= Ra.hotel_id
					WHERE Ho.hotel_city=".$city. $hotel_enabled. "
					GROUP BY hotel_id
 ...
 /*===Price===================================================================================================================================*/
 	if(isset($_GET['pmin'])&&isset($_GET['pmax']))
	{
		...
		$q_price_range=" FROM tbl_hotels AS Ho WHERE Ho.hotel_city=".$city. $hotel_enabled . " AND Ho.hotel_lowest_price BETWEEN ".$pmin." AND ".$pmax;
 ...
 /*===Price===================================================================================================================================*/
 	if(isset($_GET['facility']))
	{
		...
		$q_facility = ", Fa.facility_id
					...
					WHERE Ho.hotel_city=".$city." AND Fa.facility_id=".$facility. $hotel_enabled . "
					GROUP BY hotel_id
					ORDER BY RAND()";
